...
def test_get_reports(client: TestClient, report_data):
...
def test_get_reports_with_date_filter(client: TestClient, report_data):
...
def test_get_report_by_id(client: TestClient, report_data):
